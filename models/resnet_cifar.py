...
class ResNet_Cifar(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, fea_dim=64, gray=False, test=False):
        ...
        # self.fc0 = nn.Linear(64 * 8 * 8, fea_dim)
        self.fc = nn.Linear(fea_dim, num_classes)
...
def resnet32_cifar(gray=False, num_classes=10, fea_dim=64, **kwargs):
    model = ResNet_Cifar(BasicBlock, [5, 5, 5], gray=gray, num_classes=num_classes, fea_dim=fea_dim, **kwargs)
    return model
